...
const addSubmit = () => {
  formRef.value
    ...
    .then(() => {
      ...
      return addUser(pageState.formState);
    })
    .then((data: any) => {
...
<template>
  ...
  >
    <a-row :gutter="[16, 3]">
      <a-col :span="12">
        <a-form-item label="アカウント" name="username">
          <a-input v-model:value="pageState.formState.username" />
        </a-form-item>
      </a-col>
      <a-col :span="12">
        <a-form-item label="パスワード" name="password">
          <a-input-password v-model:value="pageState.formState.password" />
        </a-form-item>
      </a-col>
      <a-col :span="12">
